...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'shivakrishnareddy.si4@gmail.com' ")
...
message3 = tk.Label(window, text="Face Recognition System" ,fg="white",bg="#262523" ,width=55 ,height=1,font=('times', 29, ' bold '))
...
trackImg = tk.Button(frame1, text="Scan Person", command=TrackImages  ,fg="black"  ,bg="yellow"  ,width=35  ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
